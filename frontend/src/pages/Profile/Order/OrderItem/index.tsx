              ...
              <div className="order-item-product">
                ...
                <div className="order-item-product-content">
                  ...
                  <div className="order-item-product-content-prices">
                    <span className="order-item-product-content-prices-old-price">{i.price}</span>
                    <span className="order-item-product-content-prices-net-price">{getDiscountPrice(i.price, i.discount).toFixed(2)}</span>
                  </div>
                </div>
              </div>
            ))}
